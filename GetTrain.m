clear
train= zeros(100, 256 ,256,1); %训练数据是100张256*256的欠采样重建的脑图，杨亲亲说直接用重建出来的实部数据，所以是一个通道
mask_dirname = 'C:\qq CACHE\459972668\FileRecv\data\mask\30.tif' 
